...
Sign up (free, no credit card) → **Developers** (bottom of the left panel) → **API Keys** → **Create API Key** → copy and paste into the setup wizard.

**OpenAI Whisper** — Great alternative if you already have an OpenAI API key.

**Custom API** — Any Whisper-compatible endpoint (faster-whisper-server, whisper.cpp, etc.)
